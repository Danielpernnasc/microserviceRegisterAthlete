...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
            return http
                   ...
                   .requestMatchers(HttpMethod.PUT, "/athlete/*").authenticated()
                   .requestMatchers(HttpMethod.DELETE, "/athlete/*").authenticated()
                   .requestMatchers(HttpMethod.PATCH, "/athlete/*").authenticated()
